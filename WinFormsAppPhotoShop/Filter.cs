...
namespace WinFormsAppPhotoShop
{
    ...
    internal class Filter
    {
        ...
        public static RGB CalculationOfColor(UInt32 pixel, double coefficent )
        {
            RGB Color = new RGB();
            Color.R = (float)(coefficent * ((pixel & 0x00FF0000) >> 16));
            Color.G = (float)(coefficent * ((pixel & 0x0000FF00) >> 8));
